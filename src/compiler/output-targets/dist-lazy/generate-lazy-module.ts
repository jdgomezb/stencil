 ...
 */
function isStencilCoreResult(rollupChunkResult: d.RollupChunkResult): boolean {
  return (
 ...
 */
function isCjsFormat(rollupChunkResult: d.RollupChunkResult): boolean {
 ...
 */
function generateCaseClause(bundleId: string): string {
  return `
                case '${bundleId}':
                    return import(
                      /* webpackMode: "lazy" */
 ...
 * @returns the case clause that will load the component's file at runtime
 */
function generateCaseClauseCjs(bundleId: string): string {
  return `
                case '${bundleId}':
